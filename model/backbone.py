import torch
import torch.nn as nn                           # contains various predefined layers, loss functions, and modules 
import torch.nn.functional as F                 # functions that operate on tensors
import torch.utils.model_zoo as model_zoo       # loading pre-trained models from model repositories
import math


def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):         #creates 3x3 convolutional layer in_planes -channels
    """3x3 convolution with padding"""                                      #dilation - spacing btw kernel elements
...
model_urls = {
    ...
    # pre-trained weights for transfer learning or other purposes without training the models from scratch.
}

def ResNet34(output_stride, BatchNorm=nn.BatchNorm2d, pretrained=True, in_c=3):     #in_c - 3 RGB images
    """
...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        return out                          # Returns the processed output tensor.
